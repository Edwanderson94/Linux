...
| `sudo` | Terminal | É utilizado para realizar execuções com permissões administrativas (ao executar será solicitado a senha do seu usuario atual) | `sudo apt update`  |
