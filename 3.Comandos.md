...
| :------------------------ | :---------------------------  | :--------------------------------------------- | :-------------------------- |
| `man` (manuais de ajuda)  | Documentação | Exibe o manual do comando que está sendo solicitado             | `man sudo` |
...
| `cat` (abreviação de "concatenate") | Navegação | Exibe o conteúdo de um arquivo, concatena múltiplos arquivos ou cria/edita arquivos. | `cat arquivo.txt` Exibe o conteúdo do arquivo `arquivo.txt` no terminal |
